//
//  SPGeorgeConversationViewController.m
//  shopelia-ios
//
...
#import "SPGeorgePushNotificationsStepsView.h"
#import "SPPushNotificationsPreferencesManager.h"

@interface SPGeorgeConversationViewController () <UITableViewDataSource, UITableViewDelegate>
...
@property (strong, nonatomic) SPGeorgePushNotificationsStepsView *pushStepsView;
@property (strong, nonatomic) NSTimer *pushStepsViewTimer;
@end

@implementation SPGeorgeConversationViewController

#pragma mark - Lazy instantiation

- (SPGeorgePushNotificationsStepsView *)pushStepsView
{
    if (!_pushStepsView)
    {
        _pushStepsView = [SPGeorgePushNotificationsStepsView instanciateFromNibInBundle:[NSBundle mainBundle]];
...
- (void)validateViewController
{
    ...
    [self.delegate georgeConversationViewControllerDidEndConversation:self];
